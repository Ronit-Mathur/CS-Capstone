...
async function importOutlookCalendar(id){
    await serverHandler.current.fetchGet(SERVER_ENDPOINTS.OUTLOOK_CALENDAR_IMPORT_ENDPOINT, { id: id, username: "testuser1" }); //fix username integration
